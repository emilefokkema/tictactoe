...
import { CustomPointerEventTarget } from '../src/scripts/page/pointer-events/types';
import { createPointerEvents } from '../src/scripts/page/pointer-events/create-pointer-events';
